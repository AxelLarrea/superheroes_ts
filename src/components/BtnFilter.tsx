...
const BtnFilter = ({ cantidadChar, isMobile }: Cantidad ) => {
    ...
    return (
        <div className="group relative flex items-center" ref={dropdownRef}>
            <button 
                ...
                <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${isClicked ? 'rotate-0' : '-rotate-90'} transition-transform duration-300 ease-in-out`}>
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier"> 
