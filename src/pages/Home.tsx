            ...
            <div className="">
                <div className="max-w-[1200px] font-medium text-white text-base flex justify-between items-center h-24 m-auto">
                    ...
                    <div className="group flex items-center">
                        <button className="flex items-center gap-2 bg-primary-btn rounded-3xl group-hover:rounded-s-3xl group-hover:rounded-e-none px-4 py-2">
                            Todos
                        ...
                        <ul className="hidden bg-primary-header rounded-3xl group-hover:flex group-hover:rounded-s-none group-hover:rounded-e-3xl shadow-md">
                            <li className="hover:bg-primary-btn px-4 py-2" value="Todos">
                                <span className="text-center">Todos</span>
                            </li>

                            <li className="hover:bg-primary-btn px-4 py-2" value="DC">
                                <span className="text-center">DC</span>
                            </li>

                            <li className="hover:bg-primary-btn px-4 py-2 rounded-e-3xl" value="Marvel">
